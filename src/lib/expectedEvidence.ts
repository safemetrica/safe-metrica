...
export const EXPECTED_EVIDENCE_RULES: ExpectedEvidenceRule[] = [
  {
    ...
    reason: "차량 점검 작업은 TBM 실시 증빙 외에 실제 차량 상태와 점검 결과를 확인할 수 있는 증빙이 필요합니다.",
  },
  {
    ...
    reason: "차량과 보행자가 혼재되는 작업은 동선 분리와 통제 상태가 보이는 사진이 증빙력에 중요합니다.",
  },
  {
    id: "retaining-wall",
    label: "축대·구조물 공사",
  ...
  },
  {
    ...
    reason: "미끄럼·전도 위험은 바닥상태와 조치 후 상태가 확인되어야 증빙 신뢰도가 높아집니다.",
  },
  {
    id: "load-cover",
    label: "적재물·덮개 확인",
  ...
  },
  {
    ...
    reason: "장비·설비 작업은 위험부위와 안전조치 상태가 확인되는 증빙이 필요합니다.",
  },
];
