    ...
    <main className="min-h-screen bg-[#F3F5F8] text-slate-950 lg:flex">
      ...
      <section className="min-w-0 flex-1">
        ...
        <div className="mx-auto flex w-full max-w-[1220px] flex-col gap-5 px-4 py-5 lg:px-7">
          <section className="grid gap-5 rounded-[1.25rem] border border-slate-200 bg-white p-6 shadow-[0_1px_2px_rgba(15,23,42,0.04)] lg:grid-cols-[1fr_260px] lg:items-center">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.08em] text-blue-600">{companyLabel}</p>
              <h1 className="mt-1 text-3xl font-black tracking-tight text-slate-950">월간 안전운영 요약</h1>
              <p className="mt-2 text-sm font-bold text-slate-500">{periodLabel} · {periodRangeLabel}</p>
              <p className="mt-4 max-w-2xl text-sm font-semibold leading-6 text-slate-500">이번 달 현장 공유·확인·의견 기록을 운영기록 관점에서 정리했습니다.</p>
            ...
            <div className="grid gap-2 sm:grid-cols-3 lg:grid-cols-1">
              <div className="rounded-2xl bg-slate-50 px-4 py-3"><p className="text-xs font-bold text-slate-500">이번 달 총 접수</p><p className="mt-1 text-xl font-black text-slate-950">{totalCount}건</p></div>
              <div className="rounded-2xl bg-blue-50 px-4 py-3"><p className="text-xs font-bold text-blue-700">현장 확인</p><p className="mt-1 text-xl font-black text-blue-950">{fieldCount}건</p></div>
              <div className="rounded-2xl bg-teal-50 px-4 py-3"><p className="text-xs font-bold text-teal-700">근로자대표 확인</p><p className="mt-1 text-xl font-black text-teal-950">{representativeCount}건</p></div>
            </div>
          </section>
          ...
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_316px]">
            <div className="flex min-w-0 flex-col gap-5">
              <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
                ...
                <h2 className="mt-2 text-xl font-black tracking-tight text-slate-950">공유·확인·의견 흐름 요약</h2>
              ...
              <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
                <div className="flex flex-wrap items-baseline justify-between gap-2 px-5 pt-5">
                  <h2 className="text-base font-black text-slate-950">월간 결과 구성</h2>
                ...
                <p className="border-t border-slate-100 px-5 py-3 text-xs font-semibold leading-5 text-slate-400">막대는 이번 달 총 접수 {totalCount}건 대비 비중입니다.</p>
              </section>
            </div>

            <aside className="flex flex-col gap-5">
              <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
                <h2 className="text-sm font-black text-slate-950">이동</h2>
              ...
              <section className="rounded-3xl bg-gradient-to-br from-[#123B8F] to-blue-700 p-5 text-white shadow-[0_8px_24px_rgba(18,59,143,0.18)]">
                ...
                <h2 className="mt-2 text-lg font-black tracking-tight">이번 달 기록 흐름</h2>
