...
const INTERNAL_MANAGER_LINKS = [
  {
    ...
    description:
      "공유확인, 현장 의견, 근로자대표 참여확인, 전달자료, 월간 안전운영 결과물을 확인합니다.",
  },
  {
    ...
    >
      ...
      >
        {isRichiFullOperation
          ...
          : "근로자대표 참여확인 제출 링크는 고정 링크가 아니라 관리 화면에서 확인 범위와 만료일을 지정해 고유 확인 링크 방식으로 발급합니다. 고객별 안내문에는 실제 고객 데이터, 내부 인증정보, 내부 관리 주소를 포함하지 않습니다."}
      </div>
    </section>
  );
}
