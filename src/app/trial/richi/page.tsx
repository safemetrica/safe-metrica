const primaryFlows = [
  {
    step: "01",
    title: "근로자 전자확인",
    desc: "QR로 접속해 작업 전 위생·안전 확인, 의견 제출, 사진 첨부, 모바일 자필 확인서명을 남깁니다.",
  ...
  },
  {
    step: "03",
    title: "주간 요약 후보",
    desc: "운영 기간 동안 남긴 확인 기록과 의견을 주간 요약 후보 형태로 확인합니다.",
...
const commonModules = [
  {
    title: "말로 TBM 체험",
    desc: "현장관리자가 말로 작업내용을 남기고 TBM 초안으로 정리하는 확장 후보 기능입니다.",
    status: "확장 후보",
    href: "/partner-demo/tbm",
  },
  {
    title: "사진증빙 체험",
    desc: "작업 전·후 사진과 조치사진을 운영기록 후보로 남기는 확장 후보 기능입니다.",
    status: "확장 후보",
    href: "/partner-demo/manager",
  },
  {
    title: "PTW 확장 후보",
    desc: "고위험 작업 전 확인 흐름을 보여주는 확장 후보 항목입니다. 리치 운영팩 v1에서는 원장 저장 없이 안내만 제공합니다.",
    status: "준비 중",
    href: "",
  },
  {
    title: "대표·관리자 확인 흐름",
    desc: "현장 입력이 관리자 확인과 대표 요약 후보로 이어지는 SafeMetrica 공통 운영 흐름입니다.",
    status: "확장 후보",
      ...
      <section className="mx-auto max-w-[760px]">
        <div className="rounded-[30px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-2 text-3xl font-black tracking-tight">
            ㈜리치코리아 Food Factory 운영팩
          </h1>
          <p className="mt-4 text-base leading-7 text-slate-600">
            식품공장 현장에서 작업 전 위생·안전 확인, 의견 접수, 관리자 검토 후보, 주간 요약 후보까지 이어지는 운영 흐름입니다.
          </p>
        ...
        <div className="mt-5 rounded-[28px] border border-blue-100 bg-blue-50 p-5">
          ...
          <h2 className="mt-2 text-2xl font-black text-blue-950">리치코리아 운영 핵심 흐름</h2>
          <p className="mt-3 text-sm leading-6 text-blue-900">
            근로자 입력에서 관리자 검토 후보, 주간 요약 후보까지 이어지는 업종팩 기본 흐름입니다.
          </p>
        </div>
        ...
        <div className="mt-6 rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-sm font-black text-slate-500">2층 · SafeMetrica 공통 확장 후보</p>
          <h2 className="mt-2 text-2xl font-black">운영 전환 시 확장 가능한 기능</h2>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            아래 기능은 리치 Food Factory 운영팩 v1의 원장 저장 흐름과 분리된 확장 후보입니다. 운영 전환 시 업종팩과 현장 상황에 맞춰 단계적으로 연결합니다.
          </p>
        ...
        <div className="mt-5 rounded-[24px] border border-emerald-200 bg-emerald-50 p-5">
          ...
          <p className="mt-2 text-sm leading-6 text-emerald-950">
            리치코리아 운영팩은 식품공장 위생·안전 전자확인 업종팩의 시작 기준입니다. 회사별 코드 커스터마이징이 아니라 확인 템플릿, 문구, 테마, 보고서 후보를 조합해 확장합니다.
          </p>
        </div>

        <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm font-bold leading-6 text-amber-900">
          이 화면은 운영 흐름 확인용입니다. 법적 효력 보장, HACCP 인증 보장, 종이서명 완전 대체를 의미하지 않습니다.
        </div>
      </section>
    </main>
  );
