...
const steps = ["TBM 개시", "참여현황 확인", "조치사진 샘플", "현장비서 AI 요약", "완료"];
  ...
  return (
    <div className="mt-4 rounded-2xl border border-blue-500/30 bg-blue-950/20 p-4">
      <div className="flex gap-3">
        ...
        <div>
          <p className="rounded-2xl border border-white/10 bg-slate-950/70 px-3 py-2 text-sm font-black text-blue-100">{title}</p>
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#1e293b_0,#020617_45%,#020617_100%)] px-4 py-5 text-white">
      <div className="mx-auto w-full max-w-[430px] pb-32">
        <header className="rounded-[2rem] border border-blue-500/30 bg-slate-900/95 p-4 shadow-2xl shadow-slate-950/50">
          <div className="flex items-center justify-between gap-3">
            <Link href="/partner-demo" className="text-sm font-black text-blue-200">← 뒤로</Link>
            <div className="flex flex-col items-center gap-1"><span className="rounded-full border border-blue-400/30 bg-blue-950/40 px-3 py-1 text-xs font-black text-blue-200">현장관리자</span><span className="rounded-full bg-blue-500/15 px-2.5 py-0.5 text-[10px] font-black text-blue-100">체험 중</span></div>
          ...
          <div className="mt-4 h-3 overflow-hidden rounded-full bg-slate-800 shadow-inner">
            <div className="h-full rounded-full bg-blue-400 shadow-[0_0_18px_rgba(255,255,255,0.18)] transition-all" style={{ width: `${progress}%` }} />
          </div>
        ...
        <section className="mt-4 rounded-[2rem] border border-slate-700/90 bg-slate-900/95 p-5 shadow-2xl shadow-slate-950/40">
          {step === 0 && (
            <div>
              <div className="rounded-[1.65rem] border border-blue-500/30 bg-blue-950/20 p-5">
              ...
              <div className="mt-4 rounded-[1.35rem] border border-slate-700 bg-slate-950/70 p-4">
            ...
            <div>
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  <div key={item.label} className="flex items-center justify-between gap-3 rounded-[1.35rem] border border-slate-700 bg-slate-950/70 p-4">
          ...
          {step === 2 && (
            <div>
              <article className="rounded-[1.65rem] border border-rose-500/30 bg-rose-950/20 p-5">
          ...
          {step === 3 && (
            <div>
              <div className="rounded-[1.65rem] border border-blue-500/30 bg-blue-950/20 p-5">
                <p className="text-sm font-black text-blue-200">현장비서 AI 요약 미리보기</p>
          ...
          {step === 4 && (
            <div>
              <div className="rounded-[1.65rem] border border-blue-500/30 bg-blue-950/20 p-5 text-center">
