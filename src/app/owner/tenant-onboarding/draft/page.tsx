...
const siteActionErrorMessages: Record<string, string> = {
  ...
  site_name_too_long: "사업장명은 160자 이내로 입력해야 합니다.",
  industry_profile_too_long: "업종 정보는 80자 이내로 입력해야 합니다.",
  worker_count_band_too_long: "근로자 수 구간은 40자 이내로 입력해야 합니다.",
  ...
  site_name_duplicate: "같은 고객사에 동일한 사업장명이 이미 등록되어 있습니다.",
