      ...
      <section className="mx-auto max-w-5xl">
        ...
        <div className="mt-5 flex flex-col gap-5 rounded-3xl border border-slate-800 bg-slate-900/80 p-6 shadow-2xl md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href={`/owner/risk-share/sources/mapping?companyCode=${encodeURIComponent(companyCode)}&sourceId=${encodeURIComponent(sourceId)}&sheet=${preview.selectedSheetIndex}&headerRow=${preview.suggestedHeaderRowIndex ?? 0}`}
