...
const menus = [
  ...
  { href: "/ebm", icon: "📚", label: "Evidence Book", sub: "추가·보완 증빙 확인", color: "from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600", border: "border-emerald-500" },
...
const roleContent: Record<HomeRole, {
  ...
  manager: {
    ...
    tasks: [
      ...
      { href: "/manager/risk-share", icon: "🗂️", title: "위험성평가 공유팩", description: "위험성평가 공유확인, 근로자대표 확인, 월별 보관함을 확인합니다.", status: "월별 보관", accent: "border-teal-500/40 bg-teal-950/30", iconBg: "bg-teal-500/15" },
